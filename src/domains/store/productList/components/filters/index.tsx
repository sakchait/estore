...
const Filters = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "lg:min-w-[220px] w-[310px] ease-bitex-easeOut transition-all pb-8 duration-500 lg:w-auto max-w-[260px] absolute lg:relative h-full px-5 border-r bg-white lg:z-1 z-20 border-orange-300 overflow-y-scroll",
          showFilters ? "left-0" : "left-[-310px] lg:left-0"
        )}
      >
        <div className="lg:hidden pb-2 flex justify-between text-gray-500 items-center my-2 border-b border-orange-300">
          <h2>Filters</h2>
          <button
            onClick={() => onToggleWindow(false)}
        ...
        <div className="w-full lg:mt-0 my-4 border-b border-orange-300">
        ...
        <div className="w-full mb-4 border-b border-orange-300">
          <div className="flex justify-between mb-3.5">
        ...
        <Button
          ...
          className="w-full py-1 text-sm rounded-md text-gray-100 border-none bg-bitex-orange-500 hover:bg-bitex-orange-600 active:bg-bitex-orange-400 disabled:bg-bitex-orange-700"
