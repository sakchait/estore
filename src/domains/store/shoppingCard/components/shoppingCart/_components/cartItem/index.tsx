      ...
      <div className={"flex flex-grow flex-col"}>
        ...
        <div className={"flex justify-between items-center mt-3"}>
          ...
          <button
            ...
            className="size-10 cursor-pointer rounded-md flex items-center justify-center transition-all duration-300 border border-white hover:border-gray-200 hover:bg-gray-100 active:border-orange-300 active:bg-gray-200"
          >
