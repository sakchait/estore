    ...
    <footer className="flex flex-col border-t bg-white z-50 border-t-gray-300 w-full">
      <div className="flex-col storeContainer">
        <div className="flex w-full items-center h-32 border-b border-b-gray-300">
          <Link href={"/"}>
            <Image alt="Bitex Logo" src={"/images/logo.svg"} width={125} height={40} />
          </Link>
          <div className="h-11 w-full relative ml-16">
            <input
              type="text"
              className="w-full h-full rounded-lg text-gray-700 border border-orange-300 pl-12 focus:border-gray-600"
              placeholder="Search"
            />
            <Image
        ...
        <section className="flex flex-col lg:flex-row items-start justify-between">
          <div>
            ...
            <h2 className="text-orange-600 font-medium my-2">+6693599959</h2>
          ...
          <div className="lg:mb-0 mb-12">
            ...
            <div className="flex w-auto justify-start">
              <input
                ...
                className="w-[200px] text-sm h-8 rounded-md px-4 border border-orange-300 focus:border-orange-800"
              />
              <Button className="h-8  px-4 ml-2 rounded-md border text-sm border-orange-300 bg-orange-100 text-orange-700  hover:bg-orange-200 active:bg-orange-300 active:text-gray-900">
                Subscribe
              </Button>
            </div>
          </div>
