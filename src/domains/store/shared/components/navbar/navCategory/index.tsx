  ...
  return (
    <div className="relative flex items-center select-none">
      <Button
        ...
        className={cn(
          ...
          isActive
            ...
            : "border-white bg-white hover:border-gray-200 hover:bg-gray-100 active:border-orange-300 active:bg-gray-200"
        )}
      >
      ...
      <div
        ref={dropdownRef}
        className={cn(
          "absolute left-0 top-10 w-64 rounded-lg border border-orange-300 bg-white/90 backdrop-blur-md shadow-lg overflow-hidden transition-all duration-300 transform",
