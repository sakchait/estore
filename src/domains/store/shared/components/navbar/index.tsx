      ...
      <section className="w-full">
        <div className="storeContainer w-full relative flex justify-between items-center">
          <Link href={"/"} className="mr-0 xl:mr-20 lg:mr-10">
            <Image alt="Bitex Logo" src={"/images/logo.svg"} width={125} height={40} quality={100} />
          </Link>
          <div className="h-11 relative flex-1 mx-6 sm:mx-10">
            <input
              type="text"
              className="text-gray-800 hidden sm:block pl-4 size-full border-orange-300 focus:border-gray-500 border rounded-lg outline-gray-500 sm:pl-12"
              placeholder="Search"
            />
            <Image
      ...
      <section className="w-full border-b-gray-400 mt-5 border-t-gray-300 border-b border-t">
        <div className="storeContainer h-[50px] flex justify-between">
          <div className="flex items-center">
            ...
            <hr className="h-4 border-l border-orange-300 mx-4 hidden sm:block" />
