...
import { ProductSpec, TAddProductFormValues } from "@/shared/types/product";
          ...
          {categorySpecs.length ? (
            <>
              {categorySpecs.map((specGroup, groupIndex) => (
                <div className="w-full flex flex-col p-3 rounded-md border border-orange-300" key={specGroup.id}>
