  ...
  return (
    <div className="relative flex h-[500px] flex-col bg-white z-10 text-sm">
      <div className="flex items-center justify-between text-gray-800">
        <h2 className="flex-grow text-base h-full pt-1.5 border-b border-orange-300">{categoryName}</h2>
        <div className="flex text-sm">
          <h3
            className={cn(
              " rounded-t-md px-4 py-3 transition-colors duration-300 border-b",
              isOption
                ? "cursor-default text-gray-900 border-b-2 border-orange-500 hover:bg-white"
                : "cursor-pointer text-gray-500 border-orange-300 hover:bg-gray-100"
            )}
