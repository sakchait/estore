  ...
  return (
    <div className="w-full flex items-center justify-between rounded-[8px] bg-gray-100 p-1.5 my-[6px] relative">
      ...
      <div className="flex items-center">
        ...
        <option
          className="cursor-pointer rounded-md select-none px-4 py-1.5 transition-all duration-300 mr-1 bg-white border border-orange-300 hover:bg-gray-200 disabled:cursor-default disabled:text-white disabled:bg-orange-500"
          disabled={!isColor}
