...
const ProductCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="imageWrapper hover:border-orange-300 w-full h-[225px] block relative rounded-xl border border-gray-200 overflow-hidden transition-all duration-500">
        <Image
          src={imgUrl[0]}
          alt={name}
          fill
