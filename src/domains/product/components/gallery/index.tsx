          ...
          images.map((image, index) => (
            <Image
              ...
              className={cn(
                ...
                index === selectedIndex ? "border-gray-400" : "cursor-pointer border-orange-300 hover:border-gray-600"
              )}
      ...
      <div className={"relative w-full h-[300px] sm:h-[540px]"}>
        {images ? (
          <Image
            ...
            alt=""
            fill
            className="cursor-zoom-in object-contain rounded-xl border border-white transition-colors duration-300 hover:border-orange-300"
          ...
          >
            {images.map((image, index) => (
              <Image
                ...
                key={index}
                className={cn(
                  "size-16 rounded-md object-contain bg-white border border-orange-300 transition-all duration-300 hover:border-gray-600",
