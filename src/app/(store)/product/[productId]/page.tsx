        ...
        <div className="w-full h-auto flex gap-12 mt-10">
          <div className="w-full flex flex-col">
            ...
            <div className="w-full mb-[100px]">
              <h2 className="font-light block text-2xl text-gray-900 py-5 border-b border-orange-300">Specification</h2>
              {productInfo ? (
                productInfo.specifications.map((spec, index) => (
                  <section key={index} className="w-full py-5 border-b border-orange-300">
