    ...
    <div className="mt-[136px] bg-white">
      <div className="w-full h-auto md:h-[130px] py-5 px-2.5 md:p-0 flex mt-32 sm:mt-0 flex-col justify-center items-center bg-gray-200/80">
        ...
        <div className="h-auto md:h-7">
          {!!subCategories?.length && (
            <div className="flex gap-3 border border-orange-300 bg-gray-100 rounded-md mt-2 px-3 py-1 text-gray-400 text-sm">
              More:
      ...
      <div className="storeContainer flex flex-col">
        <div className="flex visible lg:hidden w-full mt-3 px-3 justify-between">
          <button
            className="border border-gray-200 rounded-md cursor-pointer pr-5 py-2 pl-8 bg-white text-gray-700 text-sm tracking-[1px] bg-[url('/icons/filterIcon.svg')] bg-no-repeat bg-[position:10px_center] transition-all duration-300 hover:bg-gray-100 hover:border-orange-300 active:bg-gray-200 active:border-gray-400"
