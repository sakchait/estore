  ...
  return (
    <div className="relative w-full flex flex-col pt-3 gap-6">
      <div className="w-full relative">
        ...
        <div
          className="h-1 absolute bg-bitex-orange-500 ml-1.5"
          style={{
      ...
      <div className="flex h-auto gap-3 text-sm text-gray-700 transition-[border] duration-300">
        <div>
          ...
          <input
            className="w-full h-7 rounded-md p-3 border border-orange-300 hover:border-gray-900"
            type="number"
            value={sliderValues[0]}
            onChange={(e) => handleChangeValue(0, e, false)}
          />
        </div>
        <hr className="h-5 mt-[31px] border-r border-orange-300" />
        <div>
