...
const Popup = ({
  ...
  return (
    <div className="fixed inset-0 overflow-hidden flex items-center justify-center">
      ...
      >
        {title && (
          <div className="flex justify-between items-center pb-3 text-gray-700 border-b border-orange-300">
            {title}
        ...
        {content}
        <div className="flex pt-4 border-t text-sm border-orange-300 justify-center items-center gap-6">
